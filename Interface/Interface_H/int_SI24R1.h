...
#define RD_RX_PLOAD     0x61  // Define RX payload register address 定义接收有效载荷寄存器地址
#define WR_TX_PLOAD     0xA0  // Define TX payload register address
#define FLUSH_TX        0xE1  // Define flush TX register command 定义清空发送寄存器指令
#define FLUSH_RX        0xE2  // Define flush RX register command 定义清空接收寄存器指令
